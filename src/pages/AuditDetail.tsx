...
const actionableQuestionMap: Record<string, string> = {
    ...
    "Sequestro de Marca (Risco)": "Estou pagando para aparecer quando buscam meu nome. Se eu parar, o cliente não me acharia no link gratuito logo abaixo? Não estamos jogando dinheiro fora com quem já me conhece?",
    ...
    "Propriedade de Ativos (Sequestro)": "Se a gente parar de trabalhar hoje, as contas de anúncios e todo o histórico ficam comigo ou estão no nome da agência? Quero ter certeza que o acesso é meu.",
    ...
    "Alinhamento de Vendas (Feedback Loop)": "Vocês sabem quais dos leads que vocês enviaram realmente fecharam contrato? Como vocês melhoram os anúncios se não sabem quem me deu lucro de verdade?",
    ...
    "Estratégia de Lance às Cegas": "Estamos focados em 'ganhar cliques' ou em 'ganhar clientes'? De que adianta ter mil acessos no site se ninguém me chama no WhatsApp no final do dia?",
    "Janela de Lucro": "Vocês sabem até quanto eu posso pagar por um cliente para eu não ter prejuízo no final do mês? Como vocês controlam os lances sem saber a minha margem?",
    "Janela de Atribuição de Influência": "Se o Instagram leva alguns dias para entender quem gosta do meu perfil, por que vocês desligam os anúncios em 24h? Não estamos impedindo a inteligência da conta de funcionar?",
